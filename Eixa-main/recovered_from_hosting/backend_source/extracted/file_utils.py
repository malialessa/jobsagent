        ...
        try:
            ...
            for i, page in enumerate(doc):
                ...
                try:
                    ...
                    logger.warning(f"Erro ao extrair texto da página {i} do PDF '{filename}': {page_e}")
                    continue
            doc.close()
            ...
            raise ValueError(f"Não foi possível processar o arquivo PDF. Verifique se o arquivo não está corrompido ou protegido por senha.")
